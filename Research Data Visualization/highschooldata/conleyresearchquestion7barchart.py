...
with open(r'C:\Users\austi\Downloads\conleyresearchdataupdated2.csv') as csv_file:
    ...
    for row in csv_reader:
        responses = row['Question 7'].split(',')
...
font_options = {'fontname': 'serif', 'fontsize': 11, 'color': 'black'}
...
plt.title("Do you think there are ethical concerns regarding ChatGPT usage?", fontdict=font_options)
...
plt.yticks(range(0, max(popularity) + 2, 2))
